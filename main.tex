...
%	{
%		& Játékmotorok   & Fizetős könyvtárak & Egyedi megoldás\\
%		Forráskód   & Zárt & Zárt & NyíltC \\
%		Sebesség   & OptimalizáltF & Többnyire optimalizált & A fejlesztőn múlik \\
%		Egyedi igények   & A & B & C \\
%		Módosítás   & F & G & H \\
%	};
%	
%	\end{tikzpicture}

%\rowcolors{2}{gray!100!white!10}{gray!100!white!1}
...
\section{Mások által elkészült tanulmányozható megoldások}
todo
...
\paragraph{A bemutatott módszer előnyei} 
\begin{compactitem}
