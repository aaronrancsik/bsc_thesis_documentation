...
\subsection{View}
Ebbe a modulba töltjük  a felhasználók által létrehozott algoritmust, illetve itt van lehetőség annak futtatására. A ''control`` modul tölti be a kiválasztott felhasználó Blockly utasításait, a Blockly utasításokat JavaScript nyelvi utasításokra fordul ebben a modulban. A különböző Blockly utasítások számára itt lehetséges egyedi JavaScript utasításokat definiálni. A JavaScript-re fordított ágens kódját ''JS-Interpreter`` segítségével futtatom \cite{BibEntry2020Feb}. A ''JS-Interpreter`` egy JavaScriptben írt JavaScript értelmező ''sandbox`` környezet, melyben biztonságosan van lehetőségem elválasztani az ágensek kódjait a böngésző valós JavaScript motorjától. Az ágensek kódja csak és kizárólag egyedileg definiált függvények segítségével tudnak kommunikálni a valós környezettel az a dokumentáció ''API hívásnak`` nevezi, jelen esetben a ''JS-Interpreter``-t könyvtárat használó fejlesztő feladata ennek a hivatkozott ''API`` elkészítése. Az utasítások végrehajtása nem valós-időben történik, folyamatosan megvárja a utasítás végrehajtásának sikerességét. 

\begin{figure}[H]
\centering
\label{fig:davinciblock}
\includegraphics[width=10cm]{davinciblock}
\caption{A da Vinci számára törénő utasítás kiadására alkalmas Blockly vezérlési szerkezet }
\end{figure}
